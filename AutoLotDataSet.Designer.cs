...
namespace Crisan_Adriana_Lab6 {
    ...
    public partial class AutoLotDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationfk_orders_cust_id;
        
        private global::System.Data.DataRelation relationfk_orders_inv_id;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationfk_orders_cust_id = this.Relations["fk_orders_cust_id"];
            this.relationfk_orders_inv_id = this.Relations["fk_orders_inv_id"];
        }
        ...
        private void InitClass() {
            ...
            this.relationfk_orders_cust_id = new global::System.Data.DataRelation("fk_orders_cust_id", new global::System.Data.DataColumn[] {
                        this.tableCustomer.CustIdColumn}, new global::System.Data.DataColumn[] {
                        this.tableOrder.CustIdColumn}, false);
            this.Relations.Add(this.relationfk_orders_cust_id);
            this.relationfk_orders_inv_id = new global::System.Data.DataRelation("fk_orders_inv_id", new global::System.Data.DataColumn[] {
                        this.tableInventory.CarIdColumn}, new global::System.Data.DataColumn[] {
                        this.tableOrder.CarIDColumn}, false);
            this.Relations.Add(this.relationfk_orders_inv_id);
        }
        ...
        public partial class InventoryDataTable : global::System.Data.TypedTableBase<InventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public InventoryRow AddInventoryRow(int CarId, string Make, string Color) {
        ...
        public partial class OrderDataTable : global::System.Data.TypedTableBase<OrderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrderRow AddOrderRow(CustomerRow parentCustomerRowByfk_orders_cust_id, InventoryRow parentInventoryRowByfk_orders_inv_id) {
                OrderRow rowOrderRow = ((OrderRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        null,
                        null,
                        null};
                if ((parentCustomerRowByfk_orders_cust_id != null)) {
                    columnValuesArray[1] = parentCustomerRowByfk_orders_cust_id[0];
                }
                if ((parentInventoryRowByfk_orders_inv_id != null)) {
                    columnValuesArray[2] = parentInventoryRowByfk_orders_inv_id[0];
                }
        ...
        public partial class CustomerRow : global::System.Data.DataRow {
            ...
            public OrderRow[] GetOrderRows() {
                if ((this.Table.ChildRelations["fk_orders_cust_id"] == null)) {
                    return new OrderRow[0];
                }
                else {
                    return ((OrderRow[])(base.GetChildRows(this.Table.ChildRelations["fk_orders_cust_id"])));
                }
            }
        }
        ...
        public partial class InventoryRow : global::System.Data.DataRow {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrderRow[] GetOrderRows() {
                if ((this.Table.ChildRelations["fk_orders_inv_id"] == null)) {
                    return new OrderRow[0];
                }
                else {
                    return ((OrderRow[])(base.GetChildRows(this.Table.ChildRelations["fk_orders_inv_id"])));
                }
            }
        }
        ...
        public partial class OrderRow : global::System.Data.DataRow {
            ...
            public CustomerRow CustomerRow {
                get {
                    return ((CustomerRow)(this.GetParentRow(this.Table.ParentRelations["fk_orders_cust_id"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["fk_orders_cust_id"]);
                }
            }
            ...
            public InventoryRow InventoryRow {
                get {
                    return ((InventoryRow)(this.GetParentRow(this.Table.ParentRelations["fk_orders_inv_id"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["fk_orders_inv_id"]);
                }
            }
...
namespace Crisan_Adriana_Lab6.AutoLotDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customer] WHERE (([CustId] = @Original_CustId) AND ((@IsNull_F" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([FirstName], [LastName]) VALUES (@FirstName, @LastN" +
                "ame);\r\nSELECT CustId, FirstName, LastName FROM Customer WHERE (CustId = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [FirstName] = @FirstName, [LastName] = @LastName WHERE (([CustId] = @Original_CustId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
SELECT CustId, FirstName, LastName FROM Customer WHERE (CustId = @CustId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Crisan_Adriana_Lab6.Properties.Settings.Default.AutoLotConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustId, FirstName, LastName FROM dbo.Customer";
        ...
        public virtual int Fill(AutoLotDataSet.CustomerDataTable dataTable) {
        ...
        public virtual AutoLotDataSet.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AutoLotDataSet.CustomerDataTable dataTable = new AutoLotDataSet.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AutoLotDataSet.CustomerDataTable dataTable) {
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Inventory] ([CarId], [Make], [Color]) VALUES (@CarId, @Make, @" +
                "Color);\r\nSELECT CarId, Make, Color FROM Inventory WHERE (CarId = @CarId)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Inventory] SET [CarId] = @CarId, [Make] = @Make, [Color] = @Color WHERE (([CarId] = @Original_CarId) AND ((@IsNull_Make = 1 AND [Make] IS NULL) OR ([Make] = @Original_Make)) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)));
SELECT CarId, Make, Color FROM Inventory WHERE (CarId = @CarId)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT CarId, Make, Color FROM dbo.Inventory";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_CarId, string Original_Make, string Original_Color) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int CarId, string Make, string Color) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CarId, string Make, string Color, int Original_CarId, string Original_Make, string Original_Color) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Make, string Color, int Original_CarId, string Original_Make, string Original_Color) {
            return this.Update(Original_CarId, Make, Color, Original_CarId, Original_Make, Original_Color);
        }
    }
...
SELECT OrderId, CustId, CarID FROM [Order] WHERE (OrderId = @OrderId)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(AutoLotDataSet.OrderDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual AutoLotDataSet.OrderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AutoLotDataSet.OrderDataTable dataTable = new AutoLotDataSet.OrderDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AutoLotDataSet.OrderDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
